...
--{sqlPreparar=sqlItems+' WHERE '+wherePaid+' AND '+whereNot_delivered+' AND '+whereNoShipped+' AND '+whereNoEmbalado;
...
--}sqlPreparar
 AND ((shipments.mode is null) or (shipments.mode='')) --whereNoMode
--}sqlPrepararAcordar
-- AND orders.date_created > '2019-09-08T00:00:00.000-00:00'
-- AND orders.date_last_updated > '2019-09-08T00:00:00.000-04:00'